    ...
    <!--    <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark font-size-14">
                            @lang('label.CURRENT_COURSE_CM_PARTICIPATION_ARMS_SERVICE_WISE', ['course' => !empty($course->name)?$course->name.' ':''])
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
    ...
    <!--    <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark font-size-14">
                            @lang('label.CURRENT_COURSE_CM_PARTICIPATION_COMMISSIONING_COURSE_WISE', ['course' => !empty($course->name)?$course->name.' ':''])
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
