...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.REQUEST_BLOOD')
            </div>
        </div>
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4" for="quantity">@lang('label.QUANTITY') :<span class="text-danger hide-mandatory-sign"> *</span>(Bag)</label>
                        <div class="col-md-4">
                            {!! Form::text('quantity', null, ['id'=> 'quantity', 'class' => 'form-control interger-decimal-only', 'autocomplete' => 'off']) !!} 
                    ...
                    <div class = "form-group">
                        ...
                        <div class="col-md-4">
                            {!! Form::select('division_id', $divisionList , null, ['class' => 'form-control js-source-states', 'id' => 'divisionId', 'autocomplete' => 'off']) !!}
                    ...
                    <div class = "form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group date datepicker2">
                                {!! Form::text('date', null, ['id'=> 'dob', 'class' => 'form-control', 'placeholder' => 'DD MM YYYY', 'readonly' => '']) !!} 
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-5 col-md-5">
                                ...
                                <a href="{{ URL::to('requestBlood') }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on('click', '#buttonSubmit', function (e) {
            ...
            swal({
                title: 'Are you sure?',
                imageUrl: "{{ asset('public/img/decision.jpg') }}",
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "{{URL::to('requestBlood/request')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
