            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header"><?php echo app('translator')->get('label.TERM_RESULT'); ?></span>
                    </div>
                </div>
            </div>
            <div class="row margin-top-10">
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong><?php echo __('label.TERM_RESULT'); ?></strong>
                </td>
            </tr>
        </table>
        <table class="no-border margin-top-10">
        ...
        <table class="table table-bordered table-hover table-head-fixer-color">
            <thead>
                <tr>
                    ...
                    <th class="vcenter text-center" rowspan="<?php echo !empty($eventMksWtArr['event'][$eventId]) && sizeof($eventMksWtArr['event'][$eventId]) > 1 ? 1 : 4; ?>"
                        colspan="<?php echo !empty($rowSpanArr['event'][$eventId]) ? $rowSpanArr['event'][$eventId] * 2 : 2; ?>">
                        <?php echo e(!empty($eventMksWtArr['event'][$eventId]['name']) ? $eventMksWtArr['event'][$eventId]['name'] : ''); ?>
...
<?php endif; ?>
<?php /**PATH E:\Xampp\htdocs\afwc\resources\views/report/termResult/print/index.blade.php ENDPATH**/ ?>