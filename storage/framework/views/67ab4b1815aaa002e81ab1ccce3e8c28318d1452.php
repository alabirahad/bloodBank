...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.DECORATION_LIST'); ?>
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('decoration/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo app('translator')->get('label.CREATE_NEW_DECORATION'); ?>
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <!-- Begin Filter-->
                <?php echo Form::open(array('group' => 'form', 'url' => 'decoration/filter','class' => 'form-horizontal')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => __('label.NAME').' / ' . __('label.SHORT_NAME'), 'placeholder' => __('label.NAME').' / ' . __('label.SHORT_NAME'), 'list' => 'decorationName', 'autocomplete' => 'off']); ?> 
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="vcenter"><?php echo app('translator')->get('label.SHORT_INFO'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    <?php echo e(Form::open(array('url' => 'decoration/' . $target->id.Helper::queryPageStr($qpArr)))); ?>

                                    <?php echo e(Form::hidden('_method', 'DELETE')); ?>


                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="<?php echo e(URL::to('decoration/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="8" class="vcenter"><?php echo app('translator')->get('label.NO_DECORATION_FOUND'); ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/decoration/index.blade.php ENDPATH**/ ?>