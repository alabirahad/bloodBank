            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header"><?php echo app('translator')->get('label.EVENT_RESULT_COMBINED'); ?></span>
                    </div>
                </div>
            </div>
            <div class="row margin-top-10">
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong><?php echo __('label.EVENT_RESULT_COMBINED'); ?></strong>
                </td>
            </tr>
        </table>
        <table class="no-border margin-top-10">
...
<?php endif; ?>
<?php /**PATH E:\Xampp\htdocs\afwc\resources\views/report/eventResultCombined/print/index.blade.php ENDPATH**/ ?>