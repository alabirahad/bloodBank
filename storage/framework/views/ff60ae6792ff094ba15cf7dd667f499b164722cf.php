...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.MODERATION_MARKING_LIMIT_MENU'); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('moderationMarkingLimit/getMarkingLimit')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on('click', '.button-submit', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(URL::to('moderationMarkingLimit/saveMarkingLimit')); ?>",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
                        ...
                        data: form_data,
                        success: function (res) {
                            toastr.success('<?php echo app('translator')->get("label.MODERATION_MARKING_LIMIT_HAS_BEEN_ASSIGNED"); ?>', res, options);
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/moderationMarkingLimit/index.blade.php ENDPATH**/ ?>