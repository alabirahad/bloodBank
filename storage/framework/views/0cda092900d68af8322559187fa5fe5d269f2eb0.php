...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.PERFORMANCE_ANALYSIS'); ?>
            </div>
        </div>
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'performanceAnalysisReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')); ?>
    ...
    $(function () {
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            if (trainingYearId == 0) {
                ...
                $('#cmId').html("<option value='0'><?php echo app('translator')->get('label.ALL_CM'); ?></option>");
                return false;
            }
            $.ajax({
                url: "<?php echo e(URL::to('performanceAnalysisReport/getCourse')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('performanceAnalysisReport/getTerm')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#termId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('performanceAnalysisReport/getCm')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/report/performanceAnalysis/index.blade.php ENDPATH**/ ?>