...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'mutualAssessmentDetailedReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')); ?>
                ...
                <div class="col-md-12 table-responsive">
                    <div class="max-height-500 webkit-scrollbar">
                        <table class="table table-bordered table-hover table-head-fixer-color" id="dataTable">
                            <thead>
                                <tr>
                                    <th class="vcenter text-center" rowspan="2"><?php echo app('translator')->get('label.SL'); ?></th>
                                    <th class="vcenter" rowspan="2"><?php echo app('translator')->get('label.CM'); ?></th>
                                    <th class="vcenter text-center" colspan="<?php echo e(!empty($cmArr) ? sizeof($cmArr) : 1); ?>"><?php echo app('translator')->get('label.CM_MARKING'); ?></th>
                                    <th class="vcenter text-center" rowspan="2"><?php echo app('translator')->get('label.AVG'); ?></th>
                                    <th class="vcenter text-center" rowspan="2"><?php echo app('translator')->get('label.POSITION'); ?></th>
                                </tr>
                                <tr>
                                    ...
                                    ?>
                                    <th class="vcenter text-center"><?php echo $cmName ?? ''; ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php
                                    $alignment = !empty($markingPositionArr[$markingCmId][$cmId]['pos']) ? 'right' : 'center';
                                    ?>
                                    <td class="vcenter text-<?php echo e($alignment); ?>"><?php echo $markingPositionArr[$markingCmId][$cmId]['pos'] ?? '--'; ?></td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php else: ?>
                                <tr>
                                    <td colspan="5"><strong><?php echo app('translator')->get('label.NO_CM_IS_ASSIGNED_TO_THIS_SYN_OR_SUB_SYN'); ?></strong></td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('mutualAssessmentDetailedReport/getCourse')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('mutualAssessmentDetailedReport/getTerm')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#termId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('mutualAssessmentDetailedReport/getMaEvent')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#synId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('mutualAssessmentDetailedReport/getsubSyn')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/report/mutualAssessmentDetailed/index.blade.php ENDPATH**/ ?>