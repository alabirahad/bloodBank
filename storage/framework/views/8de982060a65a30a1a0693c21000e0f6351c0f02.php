...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.COURSE_RESULT'); ?>
            </div>
        </div>
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'courseResultReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')); ?>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('courseResultReport/getCourse')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/report/courseResult/index.blade.php ENDPATH**/ ?>