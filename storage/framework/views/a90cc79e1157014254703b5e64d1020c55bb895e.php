<div class="row">
            ...
            <table class="table table-bordered table-hover table-head-fixer-color">
                <thead>
                    <tr>
                        ...
                        <?php echo Form::hidden('assigned_wt',!empty($assignedObsnInfo->ci_obsn_wt) ? $assignedObsnInfo->ci_obsn_wt : 0,['id' => 'assignedWtId']); ?>
                    ...
                    <tr>
                        ...
                        <th class="vcenter text-center">
                            ...
                            <?php echo Form::hidden('total_wt_after_ci',!empty($eventMksWtArr['total_wt_after_ci']) ? $eventMksWtArr['total_wt_after_ci'] : 0,['id' => 'afterCiWtId']); ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="vcenter width-80">
                            <span class="form-control integer-decimal-only width-inherit text-right" id="totalTermWt_<?php echo e($cmId); ?>">
                        ...
                        <td class="vcenter width-80">
                            <?php echo Form::text('wt['.$cmId.'][ci_obsn]',!empty($cmInfo['ci_obsn']) ? $cmInfo['ci_obsn'] : null,['id' => 'ciObsnId_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right ' . $givenWt,'autocomplete'=>'off',$readonly]); ?> 
                        </td>

                        <td class="vcenter width-80">
                            <?php echo Form::text('wt['.$cmId.'][total_wt]',!empty($cmInfo['total_wt']) ? $cmInfo['total_wt'] : null,['id' => 'totalWt_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right','readonly','autocomplete'=>'off']); ?> 
                        </td>
                        <td class="vcenter width-80">
                            <?php echo Form::text('wt['.$cmId.'][percentage]',!empty($cmInfo['percent']) ? $cmInfo['percent'] : null,['id' => 'percentId_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right','readonly','autocomplete'=>'off']); ?> 
                        </td>
                        <td class="vcenter width-80">
                        ...
                        <?php echo Form::hidden('wt['.$cmId.'][grade_id]',!empty($cmInfo['grade_id']) ? $cmInfo['grade_id'] : null,['id' => 'gradeId_'.$cmId]); ?>
    ...
    <div class="col-md-12 margin-top-10">
        <div class="row">
            ...
            <?php if($ciObsnLockInfo['status'] == '1'): ?>
            ...
            <?php elseif($ciObsnLockInfo['status'] == '2'): ?>
            <div class="col-md-12">
                <div class="alert alert-danger alert-dismissable">
                    <p><strong><i class="fa fa-unlock"></i> <?php echo __('label.REQUESTED_TO_COMDT_FOR_UNLOCK'); ?></strong></p>
                </div>
            </div>
            <?php endif; ?>
            <?php else: ?>
    ...
    <div class="col-md-12 margin-top-10">
        <div class="alert alert-danger alert-dismissable">
            <p><strong><i class="fa fa-bell-o fa-fw"></i> <?php echo __('label.ALL_TERMS_ARE_NOT_CLOSED_YET'); ?></strong></p>
        </div>
    </div>
    <?php endif; ?>
    <?php else: ?>
...
<?php /**PATH E:\Xampp\htdocs\afwc\resources\views/ciObsnMarking/showCmMarkingList.blade.php ENDPATH**/ ?>