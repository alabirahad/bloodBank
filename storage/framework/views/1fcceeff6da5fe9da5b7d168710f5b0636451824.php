...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cog"></i><?php echo app('translator')->get('label.ARMS_SERVICES_LIST'); ?>
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('armsService/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo app('translator')->get('label.CREATE_NEW_ARMS_SERVICE'); ?>
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                <?php echo Form::open(array('group' => 'form', 'url' => 'armsService/filter','class' => 'form-horizontal')); ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => 'Name / Code', 'placeholder' => 'Name / Code', 'list' => 'armsServiceName', 'autocomplete' => 'off']); ?> 
...
<!--            <div class="row">
                <div class="col-md-offset-8 col-md-4" id="manageEvDiv">
                    <a class="btn btn-icon-only btn-warning tooltips vcenter" title="Download PDF" 
                       href="<?php echo e(action('ArmsServiceController@index', ['download'=>'pdf','fil_search' => Request::get('fil_search')])); ?>">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions vcenter text-center">
                                <div class="width-inherit">
                                    <?php echo e(Form::open(array('url' => 'armsService/' . $target->id.'/'.Helper::queryPageStr($qpArr)))); ?>

                                    <?php echo e(Form::hidden('_method', 'DELETE')); ?>

                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('armsService/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="8"><?php echo app('translator')->get('label.NO_ARMS_SERVICE_FOUND'); ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/armsService/index.blade.php ENDPATH**/ ?>