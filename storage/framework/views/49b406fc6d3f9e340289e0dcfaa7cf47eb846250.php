        ...
        <div class="form-group form-md-line-input">
            <div class="col-md-10">
                <div class="md-checkbox-list">
                    ...
                    <div class="md-checkbox">
                        <?php echo Form::checkbox('appt_id['.$item->id.']',$item->id, false, ['id' => $item->id, 'data-id'=>$item->id,'class'=> 'md-check event-to-appt-check']); ?>
...
<script src="<?php echo e(asset('public/js/custom.js')); ?>" type="text/javascript"></script><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/eventToApptMatrix/showAppt.blade.php ENDPATH**/ ?>