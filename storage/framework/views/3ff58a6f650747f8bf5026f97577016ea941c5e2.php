...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.EVENT_LIST'); ?>
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('event/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo app('translator')->get('label.CREATE_NEW_EVENT'); ?>
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Begin Filter-->
                    <?php echo Form::open(array('group' => 'form', 'url' => 'event/filter','class' => 'form-horizontal')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?php echo Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => 'Code', 'placeholder' => 'Code', 'list' => 'eventCode', 'autocomplete' => 'off']); ?> 
                                    <datalist id="eventCode">
                                        ...
                                        <option value="<?php echo e($item->event_code); ?>" />
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="vcenter"><?php echo app('translator')->get('label.EVENT_CODE'); ?></th>
                            <th class="vcenter"><?php echo app('translator')->get('label.EVENT_DETAIL'); ?></th>
                            <th class="text-center vcenter"><?php echo app('translator')->get('label.HAS_SUB_EVENT'); ?></th>
                            <th class="text-center vcenter"><?php echo app('translator')->get('label.HAS_DS_ASSESMENT'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="vcenter"><?php echo e($target->event_code); ?></td>
                            <td class="vcenter"><?php echo e($target->event_detail); ?></td>
                            ...
                            <td class="text-center vcenter">
                                <?php if($target->has_ds_assesment == '1'): ?>
                                <span class="label label-sm label-success"><?php echo app('translator')->get('label.YES'); ?></span>
                                <?php else: ?>
                                <span class="label label-sm label-warning"><?php echo app('translator')->get('label.NO'); ?></span>
                                <?php endif; ?>
                            ...
                            <td class="td-actions vcenter text-center">
                                <div class="width-inherit">
                                    <?php echo e(Form::open(array('url' => 'event/' . $target->id.Helper::queryPageStr($qpArr)))); ?>

                                    <?php echo e(Form::hidden('_method', 'DELETE')); ?>


                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="<?php echo e(URL::to('event/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="8" class="vcenter"><?php echo app('translator')->get('label.NO_EVENT_FOUND'); ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/event/index.blade.php ENDPATH**/ ?>