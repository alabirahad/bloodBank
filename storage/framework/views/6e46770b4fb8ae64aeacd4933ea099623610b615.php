...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.TERM_RESULT'); ?>
            </div>
        </div>
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'termResultReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')); ?>
                        ...
                        <table class="table table-bordered table-hover table-head-fixer-color">
                            <thead>
                                <tr>
                                    ...
                                    <?php endif; ?>
                                    <th class="vcenter text-center" colspan="5" rowspan="4"><?php echo app('translator')->get('label.TERM_TOTAL'); ?></th>
                                    <th class="vcenter" rowspan="5"><?php echo app('translator')->get('label.PERSONAL_NO'); ?></th>
                                    <th class="vcenter" rowspan="5"><?php echo app('translator')->get('label.RANK'); ?></th>
                                    <th class="vcenter" rowspan="5"><?php echo app('translator')->get('label.CM'); ?></th>
                                    <th class="vcenter" rowspan="5"><?php echo app('translator')->get('label.PHOTO'); ?></th>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('termResultReport/getCourse')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('termResultReport/getTerm')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\afwc\resources\views/report/termResult/index.blade.php ENDPATH**/ ?>