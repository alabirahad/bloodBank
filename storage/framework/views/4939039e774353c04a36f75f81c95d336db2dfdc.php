<div class="row margin-top-10">
    <div class="col-md-7 table-responsive webkit-scrollbar col-md-offset-2">
        <table class="table table-bordered table-hover" id="dataTable">
            <thead>
                <tr>
                    <th rowspan="2" class="text-center vcenter"><?php echo app('translator')->get('label.SL_NO'); ?></th>
                    <th rowspan="2" class="vcenter"><?php echo app('translator')->get('label.TERM'); ?></th>
<!--                    <th colspan="2" class="text-center vcenter"><?php echo app('translator')->get('label.MODERATION_MARKING_LIMIT'); ?></th>
                </tr>
                <tr>
...
<div class = "form-actions">
    <div class = "col-md-offset-4 col-md-8">
        ...
        <a href = "<?php echo e(URL::to('ciComdtModerationMarkingLimit')); ?>" class = "btn btn-circle btn-outline grey-salsa"><?php echo app('translator')->get('label.CANCEL'); ?></a>
    </div>
</div>
...
<?php /**PATH E:\Xampp\htdocs\afwc\resources\views/ciComdtModerationMarkingLimit/showMarkingLimit.blade.php ENDPATH**/ ?>