...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-user"></i><?php echo app('translator')->get('label.CREATE_USER'); ?>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo Form::select('group_id', $groupList, null, ['class' => 'form-control js-source-states', 'id' => 'groupId', 'autocomplete' => 'off']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo Form::text('full_name', null, ['id'=> 'fullName', 'class' => 'form-control', 'list' => 'userFullName', 'autocomplete' => 'off']); ?> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo Form::text('phone', null, ['id'=> 'phone', 'class' => 'form-control interger-decimal-only', 'autocomplete' => 'off']); ?> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="userEmail"><?php echo app('translator')->get('label.EMAIL'); ?> :<span class="text-danger"> *</span></label>
                            <div class="col-md-8">
                                <?php echo Form::email('email', null, ['id'=> 'userEmail', 'class' => 'form-control', 'autocomplete' => 'off']); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\bloodBank\resources\views/user/create.blade.php ENDPATH**/ ?>