        ...
        <div class="form-group form-md-line-input">
            <div class="col-md-10">
                <div class="md-checkbox-list">
                    ...
                    <?php
                    //disable
                    $disabled = in_array($item->id, array_keys($disableCmGroup)) ? 'disabled' : '';

                    $plComdrAssignCmGroupName = in_array($item->id, array_keys($disableCmGroup)) ? $disableCmGroup[$item->id] . ' ' . __('label.ASSIGNED_TO_PL_COMDR_TO_PALTOON') : '';
                    ...
                    if (!empty($previousDataList[$item->id])) {
                        if (in_array($previousDataList[$item->id], $previousDataList)) {
                            ...
                            if (!empty($plComdrAssignCmGroupName)) {
                                $title = $plComdrAssignCmGroupName;
                            } else {
