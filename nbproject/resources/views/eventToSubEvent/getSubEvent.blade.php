        ...
        <table class="table table-bordered table-hover" id="dataTable">
            ...
            <tbody>
                ...
                if (!empty($prevEventToSubEventList)) {
                    $checked = array_key_exists($target->id, $prevEventToSubEventList) ? 'checked' : '';
                ...
                <tr>
                    ...
                    <td class="vcenter">
                        <div class="md-checkbox has-success tooltips" >
                            {!! Form::checkbox('sub_event_id['.$target->id.']',$target->id, $checked, ['id' => $target->id, 'data-id'=>$target->id, 'class'=> 'md-check event-to-sub-event']) !!}
                    ...
                    <td class="vcenter">
                        <div class="md-checkbox">
                            ...
                            , 'data-id'=>$target->id, 'class'=> 'md-check has-checked has-sub-sub-event has-sub-sub-event-'.$target->id, $disabledHasSubSubEvent]) !!}
