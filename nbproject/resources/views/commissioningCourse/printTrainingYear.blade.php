<html>
    ...
    <body>
        ...
        <div class="header">
            <p>@lang('label.TRAINING_YEAR_LIST')</p>
        </div>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center vcenter">{{ Helper::printDate($target->start_date) .' '. __('label.TO') .' '.  Helper::printDate($target->end_date) }}</td>
                ...
                @else
                <tr>
                    <td colspan="5" class="vcenter">@lang('label.NO_USER_FOUND')</td>
                </tr>
                @endif
            </tbody>
        </table>
