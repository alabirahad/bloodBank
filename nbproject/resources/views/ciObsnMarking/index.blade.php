...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-pencil"></i>@lang('label.OBSN_MARKING')
            </div>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12 ">
                            <div class="alert alert-danger alert-dismissable">
                                <p><strong><i class="fa fa-bell-o fa-fw"></i> {!! __('label.NO_COURSE_IS_ASSIGNED_TO_THIS_ACTIVE_TRAINING_YEAR') !!}</strong></p>
                            </div>
                        </div>
                        @endif
                    </div>
