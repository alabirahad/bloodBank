...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.EDIT_FACTOR_CLASSIFICATION')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('factorClassification.update', $target->id), 'method' => 'PATCH', 'files'=> true, 'class' => 'form-horizontal'] ) !!}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('short_info', Request::old('short_info'), ['id'=> 'shortInfo', 'class' => 'form-control', 'autocomplete' => 'off']) !!} 
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/factorClassification'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on("change", "#serviceId", function() {
            ...
            $.ajax({
                url: "{{URL::to('factorClassification/getOrder')}}",
                data: {
