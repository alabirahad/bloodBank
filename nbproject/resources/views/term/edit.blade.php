...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cubes"></i>@lang('label.EDIT_TERM')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('term.update', $target->id), 'method' => 'PATCH', 'class' => 'form-horizontal'] ) !!}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('name', Request::get('name'), ['id'=> 'name', 'class' => 'form-control', 'autocomplete' => 'off']) !!} 
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/term'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
