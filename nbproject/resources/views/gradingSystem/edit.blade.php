                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('grade_name',  Request::old('grade_name'), ['id'=> 'marks_to', 'class' => 'form-control', 'autocomplete' => 'off']) !!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('start_range',  Request::old('marks_from'), ['id'=> 'startRange', 'class' => 'form-control start-range range', 'autocomplete' => 'off']) !!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('end_range',  Request::old('marks_to'), ['id'=> 'endRange', 'class' => 'form-control end-range range', 'autocomplete' => 'off']) !!} 
