...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.EDIT_SUB_EVENT')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('subEvent.update', $target->id), 'method' => 'PATCH', 'files'=> true, 'class' => 'form-horizontal'] ) !!}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="event_code">@lang('label.SUB_EVENT_CODE') :<span class="text-danger"> *</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="event_detail">@lang('label.SUB_EVENT_DETAIL') :<span class="text-danger"> *</span></label>
                            <div class="col-md-8">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/subEvent'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
