<div class="modal-content" >
    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-4">
                @lang('label.TERM'):&nbsp;<strong>{{!empty($termToEventInfo->term_name)?$termToEventInfo->term_name:''}}</strong>
            </div>
            <div class="col-md-4">
                @lang('label.EVENT'):&nbsp;<strong>{{!empty($termToEventInfo->event_name)?$termToEventInfo->event_name:''}}</strong>
            </div>
        </div>
                    ...
                    <table class="table table-bordered table-head-fixer-color">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="vcenter">{{!empty($info['marking_ds_name'])?$info['marking_ds_name']:''}}</td>
