<div class="modal-content" >
    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-4">
                @lang('label.TERM'):&nbsp;<strong>{{!empty($termToIpftInfo->term_name)?$termToIpftInfo->term_name:''}}</strong>
            </div>
            <div class="col-md-4">
                @lang('label.WEEK'):&nbsp;<strong>{{!empty($ipftNameArr[$termToIpftInfo->ipft_id]) ? $ipftNameArr[$termToIpftInfo->ipft_id] : ''}}</strong>
            </div>
        </div>
