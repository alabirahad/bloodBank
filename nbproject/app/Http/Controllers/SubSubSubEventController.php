...
class SubSubSubEventController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $nameArr = SubSubSubEvent::select('event_code')->orderBy('order', 'asc')->get();

        //passing param for custom function
        $qpArr = $request->all();

        $targetArr = SubSubSubEvent::select('sub_sub_sub_event.id', 'sub_sub_sub_event.event_code',
                'sub_sub_sub_event.event_detail' , 'sub_sub_sub_event.order', 'sub_sub_sub_event.status' )
        ...
        if ($request->download == 'pdf') {
            ...
            return view('subSubSubEvent.index')->with(compact('targetArr', 'qpArr', 'nameArr'));
        }
    }
