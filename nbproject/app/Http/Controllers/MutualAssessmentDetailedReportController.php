...
//            exit;
            ...
            $fileName = 'Mutual_Assessment_Detailed_Report' . $tyName . $courseName . $termName . $synName . $eventName . $subSynName;
        }
    ...
    public function getTerm(Request $request) {
        ...
        $html1 = view('report.mutualAssessmentDetailed.getSyn', compact('synList'))->render();
    ...
    public function getMaEvent(Request $request) {
        ...
        $html = view('report.mutualAssessmentDetailed.getMaEvent', compact('maEventList'))->render();
        return Response::json(['html' => $html]);
    }
