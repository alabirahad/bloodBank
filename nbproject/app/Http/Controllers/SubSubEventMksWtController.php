...
class SubSubEventMksWtController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view('subSubEventMksWt.index')->with(compact('activeTrainingYearInfo', 'courseList'));
    }
    ...
    public function getEvent(Request $request) {
        ...
        $eventList = ['0' => __('label.SELECT_EVENT_OPT')] + TermToEvent::join('event', 'event.id', '=', 'term_to_event.event_id')
                        ...
                        ->toArray();
        $html = view('subSubEventMksWt.getEvent', compact('eventList'))->render();
