...
class CommissioningCourseController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $targetArr = CommissioningCourse::select('id', 'name', 'short_info', 'status')
                ->orderBy('id', 'asc');
        ...
        return view('commissioningCourse.index')->with(compact('targetArr', 'qpArr', 'nameArr'));
    }

    public function create(Request $request) { //passing param for custom function
        $qpArr = $request->all();
        return view('commissioningCourse.create')->with(compact('qpArr'));
    }
    ...
    public function store(Request $request) {
        ...
        $validator = Validator::make($request->all(), [
                    'name' => 'required|unique:commissioning_course',
        ]);
    ...
    public function edit(Request $request, $id) {
        ...
        //passing param for custom function
        $qpArr = $request->all();
        return view('commissioningCourse.edit')->with(compact('target', 'qpArr'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        $validator = Validator::make($request->all(), [
                    'name' => 'required|unique:commissioning_course,name,' . $id,
        ]);
    ...
    public function destroy(Request $request, $id) {
        ...
        $dependencyArr = ['CenterToBatch' => 'batch_id', 'CiObservationMarkingLock' => 'batch_id', 'CiToBatch' => 'batch_id'
            , 'CommissioningCourseReport' => 'batch_id', 'EventMarkingLock' => 'batch_id', 'EventWtDistr' => 'batch_id', 'Marking' => 'batch_id'
