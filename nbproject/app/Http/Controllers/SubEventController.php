...
class SubEventController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $nameArr = SubEvent::select('event_code')->orderBy('order', 'asc')->get();

        //passing param for custom function
        $qpArr = $request->all();

        $targetArr = SubEvent::select('sub_event.id', 'sub_event.event_code', 'sub_event.event_detail' , 'sub_event.order',
                'sub_event.status' )
        ...
        if ($request->download == 'pdf') {
            ...
            return view('subEvent.index')->with(compact('targetArr', 'qpArr', 'nameArr'));
        }
    }
